...
public static class LispINQMacros
{
    ...
    private static IEnumerable<object?> Let(ColibriRuntime runtime, Scope scope, IEnumerable<object?> enumerable, string alias, Pair bindingsPair)
    {
    ...
    private static IEnumerable<object?> OrderBy(ColibriRuntime runtime, 
    ...
    private static IEnumerable<object?> Where(ColibriRuntime runtime, 
