...
public static class PortMacros
{
    ...
    private static object? GetOutputPort(ColibriRuntime runtime, Scope scope, object? portArg)
    {
        object? port;
    ...
    private static object? GetInputPort(ColibriRuntime runtime, Scope scope, object? portArg)
    {
        object? port;
    ...
    public static object Read(ColibriRuntime runtime, Scope scope, object?[] args)
    {
        ...
        try
        {
            var node = ColibriRuntime.ParseProgramText(input);
    ...
    public static object? CallWithPort(ColibriRuntime runtime, Scope scope, object?[] args)
    {
        if (args.Length < 2)
        {
