...
{
    public static object? WithExceptionHandler(ColibriRuntime runtime, Scope scope, object?[] args)
    {
        if (args.Length != 2)
        {
    ...
    public static object? RaiseContinuable(ColibriRuntime runtime, Scope scope, object?[] args)
    {
        if (args.Length > 1)
        {
    ...
    public static object? Guard(ColibriRuntime runtime, Scope scope, object?[] args)
    {
    ...
    private static object? EvaluateGuardCondList(ColibriRuntime runtime, Scope scope, Pair condList, string variableName, object? variable)
    {
