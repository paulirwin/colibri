...
public class ListTests
{
    ...
    [InlineData("(->string (memq 'a '(a b c)))", "(a b c)")]
    [InlineData("(->string (memq 'b '(a b c)))", "(b c)")]
    [InlineData("(memq 'a '(b c d))", false)]
    [InlineData("(memq (list 'a) '(b (a) c))", false)]
    [InlineData("(->string (member (list 'a) '(b (a) c)))", "((a) c)")]
    ...
    [InlineData("(define e '((a 1) (b 2) (c 3)))(->string (assq 'a e))", "(a 1)")]
    [InlineData("(define e '((a 1) (b 2) (c 3)))(->string (assq 'b e))", "(b 2)")]
    [InlineData("(define e '((a 1) (b 2) (c 3)))(assq 'd e)", false)]
    [InlineData("(assq (list 'a) '(((a)) ((b)) ((c))))", false)]
    [InlineData("(->string (assoc (list 'a) '(((a)) ((b)) ((c)))))", "((a))")]
    [InlineData("(->string (assoc 2.0 '((1 1) (2 4) (3 9)) =))", "(2 4)")]
    [InlineData("(assq 5 '((2 3) (5 7) (11 13)))", false)]
    [InlineData("(->string (assv 5 '((2 3) (5 7) (11 13))))", "(5 7)")]
    [Theory]
